...
#define DRINK_INTERVAL 20000 // 20 seconds
#define CLEAN_INTERVAL 80000 // 80 seconds
#define PLACE_INTERVAL 20000 // 20 seconds
...
unsigned char Read_IR_Sensor() 
{
  ...
  if (ir_read == 1023)             //no Object detected
  {
